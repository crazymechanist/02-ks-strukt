...
tuple<vector <Adresat>,int> PlikZAdresatami::wczytajAdresatowZalogowanegoUzytkownikaZPliku(int idZalogowanegoUzytkownika) {
    ...
    int idOstaniegoAdresataWPliku=zwrocIdOstatniegoAdresataZPliku(daneOstaniegoAdresataWPliku);
    return make_tuple(adresaci , idOstaniegoAdresataWPliku);
}
...
int PlikZAdresatami::zwrocIdOstatniegoAdresataZPliku(string daneOstaniegoAdresataWPliku) {
    if (daneOstaniegoAdresataWPliku != "") {
        int idOstatniegoAdresata = pobierzIdAdresataZDanychOddzielonychPionowymiKreskami(daneOstaniegoAdresataWPliku);
